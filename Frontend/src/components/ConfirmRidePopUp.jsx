...
export default function ConfirmRidePopUp(props) {
  return (
    <div className="h-screen">
      {" "}
      <div className=" bg-white bottom-0 left-0 rounded-t-2xl shadow-lg ">
        <div className="mt-10 p-1 text-center text-2xl mb-5 font-semibold ">
          Would you like to take this ride!
        </div>
        ...
        <button
          ...
          className="absolute right-5 top-15 text-2xl font-bold text-gray-600 z-10"
        >
